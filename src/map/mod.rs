...
pub use catalog::{
    ...
    MapConcealmentBehavior, MapContentCatalog, MapContentPlugin, MapDamageProfile,
    MapDamageProfileId, MapDestructionBehavior, MapDimensions, MapDurabilityBehavior,
    ...
    ResolvedMapSnapshot, SAND_FLOOR_ASSET, TALL_GRASS_ASSET, TIDAL_GARDEN_ADMISSION_REVISION,
    TIDAL_GARDEN_PRESET, TWIN_VAULTS_ADMISSION_REVISION, TWIN_VAULTS_PRESET, WALL_ARENA_ASSET,
