...
pub use catalog::{
    ...
    FEATURE_YARD_WIPEOUT_PRESET, GARDEN_WALL_ASSET, GRAVESTONE_DECORATION_ASSET, GROUND_ASSET,
    ...
    MAX_MAP_DIMENSION_CELLS, MapAssetDefinition, MapAssetId, MapAssetPlacement, MapAssetSlot,
    ...
    MapInteractionBehavior, MapModeAnchorKind, MapModeAnchorPlacement, MapMutationEvent,
    MapObjectTerminalBehavior, MapPlacementOutcome, MapPlacementParameterKind,
    ...
    POWDERLINE_VAULT_PRESET, PlayerCollision, ProjectileCollision, RUBBLE_ASSET,
    ...
    WALL_DUNGEON_ASSET, WATER_ASSET, WIPEOUT_MODE_DEFINITION, cardinal_adjacency_mask,
    circle_overlaps_blocking_map, placement_cells, placement_world_center,
