...
- **Current milestone:** Milestone 11 — Implementing (slices 0–6 complete; the prediction experiment, full measurement matrix, and the Slice 7 supervised playtest remain; see [milestone-11.md](./milestone-11.md))
