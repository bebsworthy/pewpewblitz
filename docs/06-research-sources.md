...
- `references/lightyear/book/` — the local Lightyear book; begin with `src/SUMMARY.md` and follow the relevant tutorial and concept chapters, including `concepts/advanced_replication/interest_management.md` for the implemented concealment boundary and later visibility work.
