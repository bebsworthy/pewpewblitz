...
use brawler::map::{
    ...
    CACTUS_ASSET, COFFIN_DECORATION_ASSET, DAMAGE_TILE_ASSET, DESTRUCTIBLE_COVER_ASSET,
    DamageableLifeState, DamageableMaximumHealth, DamageableObjectAsset, DamageableObjectProfile,
    DamageableTargetClass, DamageableTargetIdentity, DamageableWorldObject, EffectTileKind,
    EffectTileOccupancy, EnvironmentExplosionProfile, EnvironmentExplosionProfileId,
    ...
    SPEED_TILE_ASSET, SWITCHBACK_BASIN_ADMISSION_REVISION, SWITCHBACK_BASIN_PRESET,
    SpawnAssignment, SpawnPointCatalog, SpawnPointId, TALL_GRASS_ASSET, TREASURE_CHEST_ASSET,
    TeamSpawnPoint, VERDANT_CROSSFIRE_ADMISSION_REVISION, VERDANT_CROSSFIRE_PRESET,
    WALL_ARENA_ASSET, WALL_DUNGEON_ASSET, WATER_ASSET, WIPEOUT_MODE_DEFINITION, WOOD_WALL_ASSET,
    WorldObjectCue, WorldObjectExplosionFact, WorldObjectExplosionFacts, WorldTargetDamageFact,
